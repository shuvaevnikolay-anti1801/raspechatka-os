...
def execute():
	fields = {
		"Client": [
			...
			{"fieldname": "legacy_club_revision", "label": "Версия источника", "fieldtype": "Data", "hidden": 1},
			...
			{"fieldname": "legacy_moysklad_status", "label": "Обмен МойСклад (источник)", "fieldtype": "Small Text"},
		],
		"Client Messenger": [
			{"fieldname": "legacy_channel_id", "label": "ID канала источника", "fieldtype": "Data"},
		],
		"Client Consent": [
			{"fieldname": "legacy_consent_key", "label": "Ключ согласия источника", "fieldtype": "Data", "unique": 1},
		],
		"Client Event Log": [
			{"fieldname": "legacy_event_key", "label": "Ключ события источника", "fieldtype": "Data", "unique": 1},
		],
	}
