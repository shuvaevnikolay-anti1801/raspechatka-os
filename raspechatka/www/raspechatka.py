...
def get_boot():
	...
	areas = ("dashboard", "references.network", "references.storage", "references.clients", "references.suppliers", "references.employees", "references.catalog", "references.finance", "clients.base", "clients.loyalty", "clients.marketing", "warehouse.operations", "finance.operations", "finance.planning", "finance.reporting", "finance.bank", "sales.analytics", "sales.shifts", "sales.receipts", "sales.cash", "sales.audit", "sales.integration", "settings.access")
	try:
