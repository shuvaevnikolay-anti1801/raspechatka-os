...
def get_pos_sales_settings():
	...
	return {
		...
		"review_discount_per_review": flt(getattr(settings, "review_discount_per_review", 0)),
...
def get_pos_sales_rules():
	...
	return {
		...
		"reviewDiscountPerReviewMinor": round(settings["review_discount_per_review"] * 100),
