...
const routes = [
  ...
  { path: "/references/warehouses", name: "warehouses", component: ReferencesPage, meta: { module: "warehouse", reference: "warehouses" } },
  { path: "/references/:reference(entities|points)", name: "references", component: ReferencesPage, meta: { module: "references" } },
  ...
  { path: "/references/suppliers", name: "suppliers", component: MasterDataPage, meta: { module: "warehouse", reference: "suppliers" } },
  { path: "/references/:reference(organizations|catalog-groups|catalog-units|price-types|payment-methods|pos-workplaces|cash-registers)", name: "master-data", component: MasterDataPage, meta: { module: "references" } },
