...
function addPrice() { (itemForm.prices ||= []).push({ price_type: itemOptions.price_types[0]?.name || "", business_point: "", uom: itemForm.stock_uom, currency: "RUB", rate: 0, minimum_quantity: 1 }); }
