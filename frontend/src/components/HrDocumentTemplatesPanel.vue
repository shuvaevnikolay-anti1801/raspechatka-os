    ...
    <template v-else>
      <div class="template-layout">
        ...
        <form v-if="canEdit" class="template-editor" @submit.prevent="save">
          ...
          <label>Текст шаблона
            <textarea v-model="form.template_html" rows="18" required placeholder="<h1>Трудовой договор</h1><p>{{FIO_FULL}}...</p>"></textarea>
          </label>
