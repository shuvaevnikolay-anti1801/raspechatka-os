...
export default function AppV2(){
  ...
  return <div className="app-shell">
    ...
    {screen==='orders'&&<OrdersPage orders={orders} onChanged={()=>{void refresh()}} notify={setMessage}/>} 
    ...
    {screen==='work'&&<WorkPage products={products} data={workplace} shiftOpen={Boolean(boot.shift)} onChanged={()=>{void refresh()}} notify={setMessage}/>} {payment&&<PaymentModalV2 choice={payment} total={total} rules={boot.rules} busy={busy} onChoice={setPayment} onClose={()=>setPayment(null)} onComplete={complete}/>}
